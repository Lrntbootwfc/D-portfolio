...
export default function CredibilityStrip() {
  ...
  return (
    <section className="w-full max-w-full overflow-hidden border-y border-white/[0.08] bg-paper-100/40 py-4 sm:py-5 backdrop-blur-xl">
      <div className="container-content w-full min-w-0">
        <Reveal className="flex w-full min-w-0 items-center gap-4 sm:gap-8">
          ...
          <div className="relative w-full min-w-0 flex-1 overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 sm:w-24 bg-gradient-to-r from-[var(--bg-base)] to-transparent" />
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 sm:w-24 bg-gradient-to-l from-[var(--bg-base)] to-transparent" />
            <div className="flex w-max animate-marquee gap-8 sm:gap-14 py-1">
              {items.map((item, i) => (
